INSERT INTO reporting.customer_segment_value
...
WITH customer_segments AS (
    ...
    FROM db_etl_practice_ext.customer_metrics
    GROUP BY 
        CASE 
            WHEN total_spent >= 1000 THEN 'High Value'
            WHEN total_spent >= 500 THEN 'Medium Value'
...
INSERT INTO reporting.customer_activity_analysis
...
INSERT INTO  reporting.category_performance_analysis
...
FROM db_etl_practice_ext.product_metrics
GROUP BY category
ORDER BY category_revenue DESC;


INSERT INTO reporting.top_performing_subcategories
...
INSERT INTO  reporting.customer_purchase_frequency
